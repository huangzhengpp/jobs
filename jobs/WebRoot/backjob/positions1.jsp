			...
			<div class="content">
				<dl class="company_center_content">
					...
					<ul id="gaojo" class="reset my_jobs">
						<form action="selectByPage?jiStatus=0" method="post">
							<h3>高级查询</h3>
					...
					<dd>
							<ul class="reset my_jobs">
								...
								<dd>
									...
									<ul class="reset">
										<li id="fenye"><a
	href="selectByPage?pb.pageNo=1&jiStatus=0&jiSal=${jiSal }&date1=${date1}&date2=${date2}&jiPro=${jiPro}">首页</a> <a
	href="selectByPage?pb.pageNo=${pb.first }&jiStatus=0&jiSal=${jiSal }&date1=${date1}&date2=${date2}&jiPro=${jiPro}">上一页</a> <a
	href="selectByPage?pb.pageNo=${pb.last }&jiStatus=0&jiSal=${jiSal }&date1=${date1}&date2=${date2}&jiPro=${jiPro}">下一页</a> <a
    href="selectByPage?pb.pageNo=${pb.totalPage }&jjiStatus=0&jiSal=${jiSal }&date1=${date1}&date2=${date2}&jiPro=${jiPro}">末页</a>
