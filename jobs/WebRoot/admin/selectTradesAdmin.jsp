...
<script type="text/javascript">
  function text(obj){
    document.getElementById("name").value=obj.options[obj.selectedIndex].text;
  }
    ...
    $.ajax({
			...
			success:function(date){
			  if(date.flg){
			    ...
			    document.getElementById("msg1").innerHTML=date.msg;
			  }
			}
    });
    }
			...
			<div class="content">
				...
				<dl class="company_center_content">
					...
					<ul class="reset my_jobs">
					  ...
					  <li><br/>
					  <form action="updateTradeAdmin" method="post" name="form1">
					    <select id="trade" name="trade.tid" onchange="text(this)">
					      <c:forEach items="${trades}" var="t">
					        <option value="${t.tid}"><c:out value="${t.tname}"></c:out> </option>
					      </c:forEach>
					    </select>
					    <input type="text" value="${trade.tname}" name="trade.tname" id="name"/>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<ul class="reset my_jobs">
					  ...
					  <li><br/>
					    <form action="addTradeAdmin" method="post" name="form2">
					    <input type="text" name="trade.tname" id="name1">&nbsp;&nbsp;&nbsp;&nbsp;
