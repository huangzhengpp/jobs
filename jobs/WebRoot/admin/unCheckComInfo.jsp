...
<div id="body">
    ...
    <div id="container">
          ...
          <dd>
			...
			<div class="content">
				...
				<dl class="company_center_content">
					...
					<li>
					<form method="post" action="checkCominfo">
					<p>公司名称：<input type="text" name="comInfo.comName" value="${comInfo.comName }">
						<input type="hidden" name="status" value="0">
						<input type="submit" value="查询" width="350" height="30"></p>
					</form>
					</li></ul>
						</dd>	
				...
				<div class="links">
					<a  href="comdetail?comInfo.cid=${c.cid }&status=0">审核</a> 
				</div>
								</li>
							</ul>
		...
		<dd><ul class="reset"><li id="fenye">
		 <a href="checkCominfo?status=0&comInfo.comName=${comInfo.comName }">首页</a>
		 <a  href="checkCominfo?status=0&pageNo=${pageNo==1?1:pageNo-1 }&comInfo.comName=${comInfo.comName }">上一页</a>
		 <a href="checkCominfo?status=0&pageNo=${pageNo==pageNum?pageNum:pageNo+1 }&comInfo.comName=${comInfo.comName }">下一页</a>
		 <a href="checkCominfo?status=0&pageNo=${pageNum }&comInfo.comName=${comInfo.comName }">末页</a>
		 ${pageNo }/${pageNum}页</li>
		</ul>
