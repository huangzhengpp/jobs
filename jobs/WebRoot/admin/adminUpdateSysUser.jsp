		...
		<c:if test="${loginSysuser.SType=='1' }">
			<div class="content">
				...
				<dl class="company_center_content">
					...
					<li>
					<br><br>
					<form name="form1" action="updateSysUser" method="post">
					<input type="hidden" name="sysuser.sid" value="${sysuser.sid }">
					<table>
					<tr><td><p>平台操作员登录用户名：</p></td>
					<td width="300"><input id="sysname" type="text" name="sysuser.SUsername" value="${sysuser.SUsername }"  readonly="readonly"><div id="sysnamemsg" style="display:inline;color:red;">${msg }</div></td></tr>
