          ...
          <dd>
			...
			<div class="content">
				...
				<dl class="company_center_content">
					...
					<li>
					<form method="post" action="sysUserList">
					<p>平台管理员ID：<input type="text" name="sysuser.sid" value="${comInfo.comName }">
					...
					<li data-id="149594">
						<h3>ID:${s.sid }-</h3>
					<div class="c9"><p>帐号：${s.SUsername }</p>
							<p>密码：${s.SPwd }</p>
					</div>
					<div class="links">
						<a  href="findBySysUser?sysuser.sid=${s.sid }">修改密码</a> 
					</div>
					</li>
					</ul>
